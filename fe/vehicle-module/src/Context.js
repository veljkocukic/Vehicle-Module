...
export let MainProvider = (props) => {
  ...
  let [dataSmall, setDataSmall] = useState([])
  let [smallTableOn, setSmallTableOn] = useState(false)
  let [grafikBroj,setGrafikBroj] = useState(1)
  let [grafikIme,setGrafikIme] = useState("")
  let [vremeTab,setVremeTab] = useState(false)
